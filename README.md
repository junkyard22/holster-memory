...
Three tiers:
TierRoleSpeedActive VRAMExecuting right now — layers in flightFastPassive / HolsterFull model loaded, staged and warmMediumCold storageDisk — only on initial load or full swapSlow
